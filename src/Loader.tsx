...
const Loader = ({ isLoading }: Props) => (
  <div className={`preloader ${isLoading ? '' : 'preload-finish'}`}>
    <svg className="outer-space" width="1137" height="729" viewBox="0 0 1137 729" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g id="outer-space">
        <mask id="mask0" maskUnits="userSpaceOnUse" x="0" y="0" width="1137" height="729">
          <path
            id="background"
        ...
        <g mask="url(#mask0)">
          ...
          <path
            id="star"
            style={{ animation: `stars ${Math.random() * (1.2 - 0.6) + 0.6}s infinite linear` }}
    ...
    <div className="rocket-container">
      <svg className="rocket" width="525" height="697" viewBox="0 0 525 697" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g id="rocket">
    ...
    <h3 className="loading-text">Launching Website...</h3>
  </div>
);
