...
describe('LaunchModal rendering', () => {
  ...
  it('should render the Success chip for RatSat details as launch.success is true', async () => {
  ...
  it('should render the N/A for Transporter-6 details as launch.details is null', async () => {
    render(<MockedLaunchModal id="633f72580531f07b4fdf59c6" />);
    expect(await screen.findByText('Transporter-6')).toBeInTheDocument();
